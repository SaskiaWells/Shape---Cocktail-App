...
import 'package:random_cocktail_generator/API%20calls/drinkName.dart';
...
class _CocktailState extends State<Cocktail> {
  ...
  Widget build(BuildContext context) {
    //this is the data we passed from the home page, it is initiated as a future
    final cocktail =
        ModalRoute.of(context)!.settings.arguments as Future<Drink>;
